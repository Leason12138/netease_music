<template>
  <div class="play">
    ...
    >
      <div v-show="isbarshow" class="palybar">
        <div class="palybarroot" v-if="mp3datail.al">
          ...
          <div class="musicshow" @click="isbarshow = !isbarshow">
            <div :class="{ pic: 1, picstop: runool }" ref="pic">
              <div
                class="picinside"
                :style="{
                  backgroundImage: 'url(' + mp3datail.al.picUrl + ') ',
                }"
              ></div>
            </div>
